...
- Receives apparent wind data (speed and angle) from the Autonnic A5120 via NMEA 0183 WIMWV sentences at 4,800 bit/s
...
The Autonnic A5120 communicates via NMEA 0183 at 4,800 bit/s (8N1).
...
```
Autonnic A5120 (NMEA 0183, 4,800 bit/s)
  │
